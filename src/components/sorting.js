...
export function initSorting(columns) {
  return (query, state, action) => {
    ...
    if (action && action.name === "sort") {
      // @todo: #3.1 [DONE] — запомнить выбранный режим сортировки
      ...
      // @todo: #3.2 [DONE] — сбросить сортировки остальных колонок
      ...
      // @todo: #3.3[DONE] — получить выбранный режим сортировки
      columns.forEach((column) => {
